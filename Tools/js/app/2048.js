...
function initBestScore() {
	var Swidth = screen.width/4-5;
  var tile = document.getElementsByClassName('tile');
	for(var i=0;i<tile.length;i++){
		tile[i].style.width = Swidth+"px";
		tile[i].style.height = Swidth+"px";
	}
...
function drawBackground() {
  ...
  for (var i = 0; i < game.length; i++) {
    ...
    tileDiv.style.top = y * Swidth + 'px';
    tileDiv.style.left = x * Swidth + 'px';
...
function positionTile(tile, elm) {
  ...
  var Swidth = screen.width/4-5;
  elm.style.top = y * Swidth + 'px';
  elm.style.left = x * Swidth + 'px';
}
...
function newGameStart() {
  ...
  var Swidth = screen.width/4-5;
	var back = document.getElementsByClassName('background');
	for(var i=0;i<back.length;i++){
		back[i].style.width = Swidth+"px";
		back[i].style.height = Swidth+"px";
	}
